...
```{r}
print(subset(mtcars, qsec <= 16.90))
```
...
```{r}
lightCars <- mtcars[mtcars$wt < 2000/1000, ]
print(dim(lightCars)[1])
print(lightCars)
```
...
```{r}
reddit <- read.csv(reddit)
```

### Levels and order the levels

```{r}
print(levels(reddit$age.range))
#Ordering the levels in a factor variable. 
